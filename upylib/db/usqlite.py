...
class USQLite:
    ...
    def __init__(self, db_fn):
        self.db = db_connect(db_fn)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def get_table_names(self):
        return db_get_table_names(self.db)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def is_table(self, tbl_name, verbosity=1):
        return db_is_table(self.db, tbl_name, verbosity)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def create_table(self, sql, verbosity=1):
        return db_create_table(self.db, sql, verbosity)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def drop_table(self, tbl_name, verbosity=1):
        return db_drop_table(self.db, tbl_name, verbosity)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def delete_query(self, sql, verbosity=1):
        return db_delete_query(self.db, sql, verbosity)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def select_query(self, sql, verbosity=1):
        return db_select_query(self.db, sql, verbosity)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def update_query(self, sql, verbosity=1):
        return db_update_query(self.db, sql, verbosity)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def insert_query(self, sql, data, verbosity=1):
        return db_insert_query(self.db, sql, data, verbosity)

    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~4~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~8
    def insert_query_many(self, sql, data_list, verbosity=1):
        return db_insert_query_many(self.db, sql, data_list, verbosity)
